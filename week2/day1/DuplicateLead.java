...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		*/
		...
		driv.findElement(By.linkText("Duplicate Lead")).click();
		WebElement elementCompanyName = driv.findElement(By.id("createLeadForm_companyName"));
		elementCompanyName.clear();
		elementCompanyName.sendKeys("Legato");
		WebElement elementFirstName = driv.findElement(By.id("createLeadForm_firstName"));
		elementFirstName.clear();
		elementFirstName.sendKeys("Raji");
		driv.findElement(By.name("submitButton")).click();
		System.out.println("Title of the page is "+driv.getTitle());
